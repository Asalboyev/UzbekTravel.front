...
const TurCategory = () => {
    ...
    const { data: uzbekistanTours } = useToursGet({ params: { status: '1', page: 1, limit: 3, lang } })
    const { data: internationalTours } = useToursGet({ params: { status: '0', page: 1, limit: 3, lang } })
    return (
