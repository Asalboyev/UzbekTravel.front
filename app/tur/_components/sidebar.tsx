...
const Sidebar = ({ tour }: { tour: ITour }) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            formDataToSend.append("product_id", tour?.id.toString() || "");
            const res = await request.post("/contacts", formDataToSend);
            ...
            >
                ...
                <div className="bg-card border border-border rounded-2xl p-6 shadow-lg">
                    ...
                    <div className="space-y-3">
                        <Link href={`/payme?price=${tour?.price}`}>
                                ...
                                <form onSubmit={handleSubmit}>
                                    ...
                                    <div className="flex items-center mt-4">
                                        <input
                                            ...
                                            className="mr-2"
                                        />
                                        <Label htmlFor="agreement">{t.get("tours.privacy-text")}</Label>
                                    </div>
                                    <div className="flex items-center justify-end mt-2 gap-4">
                                        ...
                                        <Button type="submit" disabled={!isAgreed}>{t.get("tours.bron")}</Button>
                                    </div>
                                </form>
                            </DialogContent>
                        </Dialog>
